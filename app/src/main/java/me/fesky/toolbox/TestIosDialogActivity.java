...
public class TestIosDialogActivity extends Activity implements OnClickListener {
    private Button btn1;
    private Button btn2;
    private Button btn3;
    private Button btn4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_ios_dialog);
        initView();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn1:
                new ActionSheetDialog(TestIosDialogActivity.this)
                        .builder()
            ...
            case R.id.btn3:
                new ActionSheetDialog(TestIosDialogActivity.this)
                        ...
                        .addSheetItem("条目一", ActionSheetDialog.SheetItemColor.Blue,
                                new ActionSheetDialog.OnSheetItemClickListener() {
                                    @Override
                                    public void onClick(int which) {
                                        Toast.makeText(TestIosDialogActivity.this,
                ...
                break;
            case R.id.btn4:
                new AlertDialog(TestIosDialogActivity.this).builder().setTitle("退出当前账号")
                ...
                break;
            case R.id.btn5:
                new AlertDialog(TestIosDialogActivity.this).builder()
